...
char *llvm::rustDemangle(const char *MangledName, char *Buf, size_t *N,
  ...
  Demangler D;
  if (!initializeOutputString(nullptr, nullptr, D.Output, 1024)) {
    if (Status != nullptr)
...
static void removeNullBytes(OutputString &Output, size_t StartIdx) {
...
static bool decodePunycode(StringView Input, OutputString &Output) {
