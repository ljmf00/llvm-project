...
struct Node {
  ...
  virtual void output(OutputString &OS, OutputFlags Flags) const = 0;
...
struct TypeNode : public Node {
  ...
  virtual void outputPre(OutputString &OS, OutputFlags Flags) const = 0;
  virtual void outputPost(OutputString &OS, OutputFlags Flags) const = 0;

  void output(OutputString &OS, OutputFlags Flags) const override {
    outputPre(OS, Flags);
    outputPost(OS, Flags);
  }
...
struct PrimitiveTypeNode : public TypeNode {
  ...
  void outputPre(OutputString &OS, OutputFlags Flags) const override;
  void outputPost(OutputString &OS, OutputFlags Flags) const override {}
...
protected:
  void outputTemplateParameters(OutputString &OS, OutputFlags Flags) const;
};
...
struct ArrayTypeNode : public TypeNode {
  ...
  void outputDimensionsImpl(OutputString &OS, OutputFlags Flags) const;
  void outputOneDimension(OutputString &OS, OutputFlags Flags, Node *N) const;
...
struct NodeArrayNode : public Node {
  ...
  void output(OutputString &OS, OutputFlags Flags, StringView Separator) const;
